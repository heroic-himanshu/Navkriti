            ...
            <div className="patient-register-container">
                ...
                <div className="flex gap-2 mb-6 border-b border-gray-200">
                    <button
                        ...
                        className={`px-6 py-3 font-medium transition rounded-t-lg ${activeTab === "basic"
                                ? "tab-button-active"
                                : "tab-button-inactive"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-6 py-3 font-medium transition rounded-t-lg ${activeTab === "medical"
                                ? "tab-button-active"
                                : "tab-button-inactive"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-6 py-3 font-medium transition rounded-t-lg ${activeTab === "medicines"
                                ? "tab-button-active"
                                : "tab-button-inactive"
                            }`}
                    >
